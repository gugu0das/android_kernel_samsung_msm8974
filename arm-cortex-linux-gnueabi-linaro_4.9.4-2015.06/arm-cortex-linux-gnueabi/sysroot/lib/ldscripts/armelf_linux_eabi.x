...
OUTPUT_ARCH(arm)
ENTRY(_start)
SEARCH_DIR("=/home/christopher/Development/toolchain-builds/arm-cortex-linux-gnueabi/arm-cortex-linux-gnueabi/lib"); SEARCH_DIR("=/usr/local/lib"); SEARCH_DIR("=/lib"); SEARCH_DIR("=/usr/lib");
SECTIONS
{
