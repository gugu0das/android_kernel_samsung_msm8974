...
#else
#define MIN_TOUCH_LIMIT		2265600
#define MIN_TOUCH_LIMIT_SECOND		1958400
#define MIN_TOUCH_LIMIT_SECOND_9LEVEL	MIN_TOUCH_LIMIT
#endif
#define MIN_TOUCH_HIGH_LIMIT	2803200
#define MIN_CAMERA_LIMIT    1728000
#endif
enum {
	DVFS_NO_ID			= 0,
...
#elif defined(CONFIG_CPU_FREQ_DEFAULT_GOV_LEEGACTIVE)
extern struct cpufreq_governor cpufreq_gov_leegactive;
#define CPUFREQ_DEFAULT_GOVERNOR        (&cpufreq_gov_leegactive)
#endif
